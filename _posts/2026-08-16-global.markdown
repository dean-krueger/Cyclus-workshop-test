...
3. Click the green "Create Codespace" button within the menu shown above to create a GitHub Codespace. This will place you in a VS Code development environment inside your browser with Cyclus pre-installed and configured. While it is loading, do not hit any buttons. It will take 2-3 minutes to fully initialize. During this initialization, it will look like this:
